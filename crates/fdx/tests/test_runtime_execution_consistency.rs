...
fn test_mixed_physicality_unsupported_first_passed_second_fails_transactionally() {
    ...
    let checks = vec![
        make_check("check_a", CheckExecutionStatus::Unsupported, "exec_mixed_1", false, vec!["node".into()]),
        make_check("check_b", CheckExecutionStatus::Passed, "exec_mixed_1", true, vec!["node".into()]),
    ];
    ...
    let run_count: i64 = db.conn.query_row("SELECT count(*) FROM runtime_runs WHERE run_id = 'run_mixed_1'", [], |r| r.get(0)).unwrap();
...
fn test_mixed_physicality_passed_first_unsupported_second_fails_transactionally() {
    ...
    let checks = vec![
        make_check("check_a", CheckExecutionStatus::Passed, "exec_mixed_2", false, vec!["node".into()]),
        make_check("check_b", CheckExecutionStatus::Unsupported, "exec_mixed_2", true, vec!["node".into()]),
    ];
    ...
    let run_count: i64 = db.conn.query_row("SELECT count(*) FROM runtime_runs WHERE run_id = 'run_mixed_2'", [], |r| r.get(0)).unwrap();
    assert_eq!(run_count, 0);
}
...
fn test_mixed_physicality_spawnfailed_first_passed_second_fails_transactionally() {
    ...
    let checks = vec![
        make_check("check_a", CheckExecutionStatus::SpawnFailed, "exec_mixed_3", false, vec!["node".into()]),
        make_check("check_b", CheckExecutionStatus::Passed, "exec_mixed_3", true, vec!["node".into()]),
    ];
...
fn test_mixed_physicality_passed_first_spawnfailed_second_fails_transactionally() {
    ...
    let checks = vec![
        make_check("check_a", CheckExecutionStatus::Passed, "exec_mixed_4", false, vec!["node".into()]),
        make_check("check_b", CheckExecutionStatus::SpawnFailed, "exec_mixed_4", true, vec!["node".into()]),
    ];
...
fn test_mixed_physicality_timedout_first_unsupported_second_fails_transactionally() {
    ...
    let checks = vec![
        make_check("check_a", CheckExecutionStatus::TimedOut, "exec_mixed_5", false, vec!["node".into()]),
        make_check("check_b", CheckExecutionStatus::Unsupported, "exec_mixed_5", true, vec!["node".into()]),
    ];
...
fn test_mixed_physicality_outputlimit_first_skipped_second_fails_transactionally() {
    ...
    let checks = vec![
        make_check("check_a", CheckExecutionStatus::OutputLimitExceeded, "exec_mixed_6", false, vec!["node".into()]),
        make_check("check_b", CheckExecutionStatus::Skipped, "exec_mixed_6", true, vec!["node".into()]),
    ];
...
fn test_nonphysical_shared_execution_with_conflicting_commands_fails() {
    ...
    let checks = vec![
        make_check("check_a", CheckExecutionStatus::Unsupported, "exec_nonphys_cmd", false, vec!["npm".into(), "test".into()]),
        make_check("check_b", CheckExecutionStatus::Unsupported, "exec_nonphys_cmd", true, vec!["cargo".into(), "test".into()]),
    ];
...
fn test_nonphysical_shared_execution_with_conflicting_cwd_fails() {
    ...
    let mut check_b = make_check("check_b", CheckExecutionStatus::Unsupported, "exec_nonphys_cwd", true, vec!["npm".into()]);
    check_b.cwd = "subdir".to_string();
    let checks = vec![
        make_check("check_a", CheckExecutionStatus::Unsupported, "exec_nonphys_cwd", false, vec!["npm".into()]),
        check_b,
    ];
...
fn test_nonphysical_shared_execution_with_conflicting_duration_fails() {
    ...
    let mut check_b = make_check("check_b", CheckExecutionStatus::SpawnFailed, "exec_nonphys_dur", true, vec!["npm".into()]);
    check_b.duration_ms = 999;
    let checks = vec![
        make_check("check_a", CheckExecutionStatus::SpawnFailed, "exec_nonphys_dur", false, vec!["npm".into()]),
        check_b,
    ];
...
fn test_shared_execution_two_primaries_fails() {
    ...
    let checks = vec![
        make_check("check_a", CheckExecutionStatus::Passed, "exec_two_prim", false, vec!["npm".into()]),
        make_check("check_b", CheckExecutionStatus::Passed, "exec_two_prim", false, vec!["npm".into()]), // Second primary!
    ];
...
fn test_shared_execution_zero_primaries_fails() {
    ...
    let checks = vec![
        make_check("check_a", CheckExecutionStatus::Passed, "exec_zero_prim", true, vec!["npm".into()]),
        make_check("check_b", CheckExecutionStatus::Passed, "exec_zero_prim", true, vec!["npm".into()]),
    ];
...
fn test_singleton_reused_execution_fails() {
    ...
    let checks = vec![
        make_check("check_a", CheckExecutionStatus::Passed, "exec_single_reused", true, vec!["npm".into()]),
    ];
...
fn test_valid_shared_physical_execution_has_one_runtime_execution_and_referential_invariant() {
    ...
    let checks = vec![
        make_check("check_a", CheckExecutionStatus::Passed, "exec_valid_phys", false, vec!["npm".into(), "test".into()]),
        make_check("check_b", CheckExecutionStatus::Passed, "exec_valid_phys", true, vec!["npm".into(), "test".into()]),
        make_check("check_c", CheckExecutionStatus::Passed, "exec_valid_phys", true, vec!["npm".into(), "test".into()]),
    ];
    ...
    let exec_count: i64 = db.conn.query_row(
...
fn test_valid_shared_nonphysical_execution_has_zero_runtime_executions_and_referential_invariant() {
    ...
    let checks = vec![
        make_check("check_a", CheckExecutionStatus::Unsupported, "exec_valid_nonphys", false, vec!["npm".into(), "test".into()]),
        make_check("check_b", CheckExecutionStatus::Unsupported, "exec_valid_nonphys", true, vec!["npm".into(), "test".into()]),
    ];
