...
| Changed directory | Focused check |
|---|---|
| `src/agents/` | `npm test -- tests/agents/` |
| `src/hooks/` | `npm test -- tests/hooks/` |
| `src/services/` | `npm test -- tests/services/` |
| `src/tools/` | `npm test -- tests/tools/` |
| `src/config/` | `npm test -- tests/config/` |
| `src/index.ts` | `npm test -- tests/index.test.ts` |
| `crates/fdx/` | `cargo test --manifest-path crates/fdx/Cargo.toml` |
| `src/skills/` | `npm run validate:skills` |
...
- Do NOT modify `plugin/dist/` manually — it is generated by `npm run build`
...
New reusable behaviors → `src/skills/<name>/SKILL.md`
